                ...
                <form id="project_form" class="flex flex-col bg-white rounded-lg gap-4 m-0" method="POST">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="flex flex-col">
                            ...
                            <input class="border-black border-2 rounded-md p-1" id="title" type="text" name="title">
                        ...
                        <div class="flex flex-col gap-2">
                            <label for="members">Miembros del Proyecto</label>
                        ...
                        <div class="flex gap-4 justify-between items-center">
                            <div class="flex flex-col">
                                ...
                                <input class="border-black border-2 rounded-md p-1" type="date" id="start_date"
                                    name="start_date" max="20124-12-31" />
                            </div>
                            <div class="flex flex-col">
                                <!-- End Date -->
                                <label for="end_date">Fecha de Entrega:</label>
                                <input class="border-black border-2 rounded-md p-1" type="date" id="end_date"
