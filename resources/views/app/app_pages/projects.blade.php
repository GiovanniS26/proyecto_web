                ...
                <div class="overflow-auto w-full flex items-center lg:justify-center flex-col">
                    <div class="overflow-auto w-fit flex flex-col items-center max-h-80">
                        <table id="project_table">
                            <tr>
                                <td class="first:rounded-l px-4 py-2 bg-red-500 text-white">Titulo</td>
                                <td class="px-4 py-2 bg-red-500 text-white">Descripción</td>
                                <td class="px-4 py-2 bg-red-500 text-white">Estado</td>
                                <td class="px-4 py-2 bg-red-500 text-white">Fecha de inicio</td>
                                <td class="px-4 py-2 bg-red-500 text-white">Fecha de entrega</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-b border-gray-300 p-4 bg-gray-100 relative">
                                            <div class="flex flex-wrap gap-2">
                                                <div>
                                                    <button id="edit_project" name="editar"
                                                ...
                                                <form class="m-0" action="{{ route('destroy_projects', $project->id) }}"
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                                    <button id="delete_project" name="eliminar"
